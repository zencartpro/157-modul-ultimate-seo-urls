 ...
 * modified for Zen Cart German 2022-03-25 webchills
 */
...
//
define('USU_CURRENT_VERSION', '3.0.11');
define('USU_CURRENT_UPDATE_DATE', '2022-03-10');
    ...
    if (!$check->EOF) {
        ...
        $db->Execute(
            "INSERT INTO " . TABLE_CONFIGURATION_GROUP . " 
             ...
             VALUES 
                ('$configurationGroupTitle', '$configurationGroupTitle Settings', '1', '1','43')"
        );
        $cgi = $db->Insert_ID(); 
        $db->Execute(
            "UPDATE " . TABLE_CONFIGURATION_GROUP . " 
